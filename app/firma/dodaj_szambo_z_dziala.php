				...
				<div class = "divDodSzaOsoba">
					...
					<div class = "divDodSzaAdrOsoba">
						<div style = "display: grid; width: 28%;">
							...
							<input id="KodAdrOsoba" name="KodAdrOsoba" class="KodAdrOsoba textDodUmoweSzamba form-control basicAutoComplete" type="text" autocomplete="off" placeholder="00-000" readonly>
						</div>
						<div class ="divOdstep"> </div>
						<div style = "display: grid; width: 70%;">
							<label class = "labDodUmowa">Miejscowość: </label>
							<input id="MiejscowoscAdrOsoba" name="MiejscowoscAdrOsoba" class="textDodUmoweSzamba form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Miejscowość" readonly>
						</div>
					</div>
					...
					<div class = "divDodSzaAdrOsoba">
						<div style = "display: grid; width: 68%;">
							...
							<input id="UlicaAdrOsoba" name="UlicaAdrOsoba" class="textDodUmoweSzamba form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Nazwa ulicy." readonly>
							
						</div>
						<div class ="divOdstep"> </div>
						<div style = "display: grid; width: 30%;">
							<label class = "labDodUmowa">Numer: </label>
							<input type="text" id="NrAdrOsoba" name="NrAdrOsoba" class = "textDodUmoweSzamba" placeholder="Wprowadz numer" readonly>
						</div>
					</div>
					
					<div style = "width:100%; text-align: right;"> 
						<input type="submit" value="Dodaj osobę" id = "bt_DodajOsobe" class ="bt_DodajOsobe butZapisz" style = "width:20%; margin-top:15px;">
					</div>
...
<script src="dodaj_szambo_z_dziala.js"></script>
</body>