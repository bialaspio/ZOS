...
try {
    ...
    $sql = "
        ...
        WHERE ok.imie || ' ' || ok.nazwisko LIKE :ImNaz
    ";
    $zapytanie = $baza_danych->prepare($sql);

    // Bindowanie parametrów
    $ImNaz = '%' . $ImNaz . '%';
    $zapytanie->bindParam(':ImNaz', $ImNaz, PDO::PARAM_STR);
