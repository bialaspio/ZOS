...
try {
    ...
    $sql = "
        ...
        LEFT JOIN osoba_adres oa ON oa.id_adr_zamel = a.ogc_fid 
        LEFT JOIN osoba o ON o.id_osoby = oa.id_osoby AND o.wlasciciel IS TRUE 
    ...
    // Wykonanie zapytania
    $zapytanie->execute();
    $przewidywane_dane_osoby = $zapytanie->fetchAll(PDO::FETCH_ASSOC);

    // Zwrócenie wyników w formacie JSON
    echo json_encode($przewidywane_dane_osoby ?: []);
