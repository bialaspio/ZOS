...
try {
    ...
    $sql = "
        SELECT DISTINCT a.ulica 
        FROM adresy a
        INNER JOIN kontrole k ON k.adres_nier_id = a.ogc_fid
        WHERE a.ulica LIKE :ulica AND a.miejscowosc LIKE :miejscowosc
        ORDER BY a.ulica
    ";
