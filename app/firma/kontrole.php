			...
			<form id="formKontrole" method="post" ">
				...
				<div class = "divChbRodzKontr" style = "margin-top: 10px; ">
					<div style = "width: 100%; margin: auto;  display: block;">
						...
						<?php
							...
							echo '<option value="">Wybierz rodzaj kontroli</option>';
				...
				<div class = "divOsoba">
					...
					<div style = "display:flex">
						<div class = "divImNazOsoba">
							...
							<input id="Imie" name="Imie" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Imie">
						</div>
						<div class ="divOdstep"> </div>
						<div class = "divImNazOsoba" >
							<label class = "labKontrola">Nazwisko.</label>
							<input id="Nazwisko" name="Nazwisko" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Nazwisko">
						</div>
					</div>
					...
					<div class = "divAdrOsoba">
						<div style = "display: grid; width: 28%;">
							...
							<input id="KodAdrWlSzamba" name="KodAdrWlSzamba" class=" textKontoleWlasciciel basicAutoComplete" type="text" autocomplete="off" placeholder="00-000" >
						</div>
						<div class ="divOdstep"> </div>
						<div style = "display: grid; width: 70%;">
							<label class = "labKontrola">Miejscowość: </label>
							<input id="MiejscowoscAdrWlSzamba" name="MiejscowoscAdrWlSzamba" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Miejscowość" >
						</div>
					</div>
					...
					<div class = "divAdrOsoba">
						<div style = "display: grid; width: 68%;">
							...
							<input id="UlicaAdrWlSzamba" name="UlicaAdrWlSzamba" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Nazwa ulicy." >
							
						</div>
						<div class ="divOdstep"> </div>
						<div <div style = "display: grid; width: 30%;">
							<label class = "labKontrola">Numer: </label>
							<input type="text" id="NrAdrWlSzamba" name="NrAdrWlSzamba" class = "textKontoleWlasciciel" placeholder="Numer" >
						</div>
					</div>
				</div>
					...
					<div class="divOsobyKontrolujace">
						<div class="inputContainer">
							<div style = "display:grid; width: 100%;">
								<input id="texOsobaKontr" name="texOsobaKontr" class="textOsobyKontrolujace form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Osoba kontrolująca." >
							</div>
							<button id="addInput" style="margin-left: 10px;">
								<img src="plus02.png" alt="plus">
							</button>
						</div>
					</div>
				</div>
				...
				<div class="divOsobyBiorUwKontr">
					...
					<div class="divDivOsobyBiorUwKontr">
						<div class="inputContainer">
							<div style = "display:grid; width: 100%;">
								<input id="texOsobaBiorUwKontr" name="texOsobaBiorUwKontr" class="textOsobyBUWK form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Osoba biorąca udział w kontroli." >
							</div>
				...
				<div class = "divAdrNier">
					...
					<div class = "divDivAdrNier">
						<div style = "display: grid; width: 28%;">
							<label class = "labKontrola">Kod:</label>
							<input id="KodAdrNier" name="KodAdrNier" class=" textKontoleWlasciciel basicAutoComplete" type="text" autocomplete="off" placeholder="00-000" >
						</div>
						<div class ="divOdstep"> </div>
						<div style = "display: grid; width: 70%;">
							<label class = "labKontrola">Miejscowość: </label>
							<input id="MiejscowoscAdrNier" name="MiejscowoscAdrNier" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Miejscowość" >
						</div>
					</div>
					...
					<div class = "divDivAdrNier">
						<div style = "display: grid; width: 68%;">
							<label class = "labKontrola">Ulica:</label>
							<input id="UlicaAdrNier" name="UlicaAdrNier" class="textKontoleWlasciciel form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Nazwa ulicy." >
							
						</div>
						<div class ="divOdstep"> </div>
						<div <div style = "display: grid; width: 30%;">
							<label class = "labKontrola">Numer: </label>
							<input type="text" id="NrAdrNier" name="NrAdrNier" class = "textKontoleWlasciciel" placeholder="Numer" >
						</div>
					</div>
				</div>
				...
				<div class="divOkazaneDokumenty">
					...
					<div class="divDivOkazaneDokumenty">
						<div class="inputContainer" style="display: flex; align-items: center;">
							<div style = "display:grid; width: 100%;">
								<input id="texOkazaneDokumenty" name="texOkazaneDokumenty" class="textOkazaneDokumenty form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Dodaj dokument" style="vertical-align: middle; width: 304px">
							</div>
				...
				<div class = "divButtZapisz" style = "padding-right: 0%">
