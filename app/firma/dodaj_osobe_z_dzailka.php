    ...
    <form id="formDodOsoba" method="post" style="display: flex;">
        <div class="divOsobaInForm">
            ...
            <div class="divImNazOsoba">
                ...
                <input id="Imie" name="Imie" class="textDodUmoweSzamba form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Imię" readonly>
            </div>
            <div class="divImNazOsoba">
                <label class="labDodUmowa">Nazwisko:</label>
                <input id="Nazwisko" name="Nazwisko" class="textDodUmoweSzamba form-control basicAutoComplete" type="text" autocomplete="off" placeholder="Nazwisko" readonly>
            </div>
            ...
            <div class="divAdrOsoba">
                ...
                <div style="display: grid; width: 30%;">
                    ...
                    <input type="text" id="NrAdrOsoba" name="NrAdrOsoba" class="textDodUmoweSzamba" placeholder="Wprowadź numer">
                </div>
            </div>

            <!-- Właściciel szamba -->
            <div class="divchbWlascicielSzamba">
                <input type="checkbox" name="chkWlascicielSzamba" id="chkWlascicielSzamba" value="chkWlascicielSzamba" checked>
...
<script src="dodaj_osobe_z_dzailka.js"></script>
