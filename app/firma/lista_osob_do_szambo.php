	...
	<nav style = " height:100px; dispaly:block">
		...
		<div style = "display:inline-block; width: 100%;" >
            ...
            <div class = "divPoleNaGorDol" >
					<h4  style = "font-size: 22px;	color:#154c79;  text-align: center; margin-bottom: 10px;">Dane adresowe szamba.</h4>
            </div>
...
<div style = "margin : auto; width:50%; align-items: center; justify-content: center; "> 
	<h4  style = "font-size: 22px;	color:#154c79;  text-align: center; margin-bottom: 10px;margin-top:10px;">Lista osób</h4>
</div>
...
<script type="text/javascript" src="lista_osob_do_szambo.js"></script> 
